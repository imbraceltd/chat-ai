...
async def get_session_user(
    ...
    if user and "object_name" in user:
        hashed = get_password_hash(IMBRACE_DEFAULT_PASSWORD)
        log.info(f"User {user['email']} not found in the database. Creating a new user.")
